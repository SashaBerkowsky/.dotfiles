...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", uns_background, "-nf", uns_foreground, "-sb", sel_background, "-sf", sel_foreground, "-p" , "App Launcher", NULL };
